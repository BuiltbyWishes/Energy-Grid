...
A live interactive visualization of the US power grid — real demand data, power plant locations, hyperscale data center draw, and energy flow. Built with React, EIA Open Data API and OpenGridWorks API.
